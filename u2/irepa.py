...
def training(runs:int=15):
    ...
    for i in tqdm(range(runs)):
        ...
        init_points  = random_positions(size = 200, xlim=[-2.,2.], ylim=[-2., 2.],zlim=[-np.pi/2, np.pi/2], as_tensor=False)

        states, values = statesValues(init_positions=init_points, horizon=150,
